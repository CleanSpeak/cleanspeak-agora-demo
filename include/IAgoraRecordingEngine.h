...
/** The IRecordingEngine class provides the main methods that can be invoked by your application. */
		...
		public:
			 ...
			 */
			static IRecordingEngine* createAgoraRecordingEngine(const char* appId,
			 ...
			 */
			virtual int joinChannel(const char* channelKey, const char* channelId, uid_t uid,
			                        const RecordingConfig& config) = 0;
