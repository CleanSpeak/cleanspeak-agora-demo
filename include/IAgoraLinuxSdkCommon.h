...
/** The layout setting of the mixed video. */
		typedef struct VideoMixingLayout {
			...
			struct Region {
				...
				Region()
						: uid(0), x(0), y(0), width(0), height(0), alpha(1.0), renderMode(1) {}
			...
			VideoMixingLayout()
					: canvasWidth(0), canvasHeight(0), backgroundColor(NULL), regionCount(0), regions(NULL),
					  appData(NULL), appDataLength(0) {}
		} VideoMixingLayout;
